...
public class Stage extends PeriodBaseEntity {
    ...
    public void update(StageNameDateVo stageNameDateVo) {
        this.sequenceNum = stageNameDateVo.getSequenceNum();
        this.taskName = stageNameDateVo.getName();
        init(stageNameDateVo.getStartDate(), stageNameDateVo.getDueDate());
    }
